...
inputFile = LOAD 'hdfs:///user/Dhrubadeep/inputs' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
-- rmf hdfs:///user/Dhrubadeep/PigProjectOutput;

-- Store the results into folder
STORE result INTO 'hdfs:///user/Dhrubadeep/PigProjectOut';